...
/**
 * The strupr only shiftd to uppercase
...
/**
 * This, as far as I can tell, is only needed for Calibration
*/
void DFRobot_PH::begin()
{
  ...
  // Serial.print("_neutralVoltage:"); // this stops unnecessary junk from shoing in out put and messing up graphs -jwilleke
  //Serial.println(this->_neutralVoltage); // this stops unnecessary junk from shoing in out put and messing up graphs -jwilleke
  ...
  // Serial.print("_acidVoltage:"); // this stops unnecessary junk from shoing in out put and messing up graphs -jwilleke
  // Serial.println(this->_acidVoltage); // this stops unnecessary junk from shoing in out put and messing up graphs -jwilleke
